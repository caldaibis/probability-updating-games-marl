...
def show_all(new: bool = True, old: bool = False, eval: bool = True, rcar: bool = False, algos: List[str] = marl.ALGOS):
    ...
    if rcar:
        # Plot rcar figures
        plot(algos, new, old, eval, game_type=pu.games.MontyHall, loss=pu.RANDOMISED_ZERO_ONE, interaction_type='zero_sum', rcar=rcar)
        plot(algos, new, old, eval, game_type=pu.games.MontyHall, loss=pu.BRIER, interaction_type='zero_sum', rcar=rcar)
        plot(algos, new, old, eval, game_type=pu.games.MontyHall, loss=pu.LOGARITHMIC, interaction_type='zero_sum', rcar=rcar)
        plot(algos, new, old, eval, game_type=pu.games.FairDie, loss=pu.RANDOMISED_ZERO_ONE, interaction_type='zero_sum', rcar=rcar)
        plot(algos, new, old, eval, game_type=pu.games.FairDie, loss=pu.BRIER, interaction_type='zero_sum', rcar=rcar)
        plot(algos, new, old, eval, game_type=pu.games.FairDie, loss=pu.LOGARITHMIC, interaction_type='zero_sum', rcar=rcar)

    else:
        # Plot mean reward figures
        plot(algos, new, old, eval, game_type=pu.games.MontyHall, loss=pu.RANDOMISED_ZERO_ONE, interaction_type='zero_sum', optimum=-0.66667)
        ...
        plot(algos, new, old, eval, game_type=pu.games.MontyHall, loss=pu.BRIER, interaction_type='zero_sum', optimum=-0.888)
        plot(algos, new, old, eval, game_type=pu.games.MontyHall, loss=pu.BRIER, interaction_type='cooperative', optimum=-0.666)
    
        plot(algos, new, old, eval, game_type=pu.games.MontyHall, loss=pu.LOGARITHMIC, interaction_type='zero_sum', optimum=-1.273, bottom=-2.5)
        ...
        plot(algos, new, old, eval, game_type=pu.games.FairDie, loss=pu.RANDOMISED_ZERO_ONE, interaction_type='zero_sum', optimum=-1.333)
        ...
        plot(algos, new, old, eval, game_type=pu.games.FairDie, loss=pu.BRIER, interaction_type='zero_sum', optimum=-1.444)
        plot(algos, new, old, eval, game_type=pu.games.FairDie, loss=pu.BRIER, interaction_type='cooperative', optimum=-1.333)
    
        plot(algos, new, old, eval, game_type=pu.games.FairDie, loss=pu.LOGARITHMIC, interaction_type='zero_sum', optimum=-2.659)
